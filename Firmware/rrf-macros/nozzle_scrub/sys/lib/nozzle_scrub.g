...
; Placeholder. The variable will later be set to contain the overhang for the brush assembly in the buckets
var brush_oh            = 0
...
if var.pos = 0                                                                 ; Left bucket selected
G1 X{var.bucket_start + ((var.bucket_left_width - var.brush_oh) / 2)}
else                                                                           ; Right bucket selected
